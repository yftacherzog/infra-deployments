...
print_help() {
    ...
    echo "  PREVIEW_WAIT_KONFLUX_CR_READY=true  When using --operator-overlay, wait for the Konflux custom resource"
    echo "                       named konflux to exist and report Ready=True (optional; off by default)."
    echo
